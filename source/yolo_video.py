...
labelsPath = os.path.sep.join([args["yolo"], classes_fname])
...
weightsPath = os.path.sep.join([args["yolo"], weights_fname])
configPath = os.path.sep.join([args["yolo"], cfg_fname])
