...
* Install [nix](https://nixos.org/guides/install-nix.html) (one-line install, but here's the [original instructions](https://nixos.org/manual/nix/stable/#chap-installation) just in case)
